        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="border border-border cursor-pointer hover:bg-cardBg duration-300 bg-black/20 rounded-lg p-6 flex items-center gap-4 hover:bg-black/30 transition">
            <div className="shrink-0">
              <div className="w-20 h-20 rounded-full bg-blue-600 border-2 border-blue-400 flex items-center justify-center text-white font-bold text-lg">
                MC
              </div>
            </div>
            <div>
          ...
          <div className="border border-border cursor-pointer hover:bg-cardBg duration-300 bg-black/20 rounded-lg p-6 flex items-center gap-4 hover:bg-black/30 transition">
            <div className="shrink-0">
              <div className="w-20 h-20 rounded-full bg-red-700 border-2 border-red-500 flex items-center justify-center text-white font-bold text-lg">
                LFC
              </div>
            </div>
            <div>
          ...
          <div className="border border-border cursor-pointer hover:bg-cardBg duration-300 bg-black/20 rounded-lg p-6 flex items-center gap-4 hover:bg-black/30 transition">
            <div className="shrink-0">
              <div className="w-20 h-20 rounded-full bg-blue-700 border-2 border-blue-500 flex items-center justify-center text-white font-bold text-lg">
                CFC
              </div>
            </div>
            <div>
