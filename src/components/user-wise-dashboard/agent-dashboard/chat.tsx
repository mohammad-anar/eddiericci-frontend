...
interface Conversation {
  ...
  user: {
    name: string;
    role: "Parent" | "Agent" | "Club" | "Academy";
    avatar: string;
  };
  lastMessage: string;
  time: string;
...
const conversations: Conversation[] = [
  ...
  {
    id: "4",
    user: { name: "Real Madrid Club", role: "Club", avatar: "https://i.pravatar.cc/100?u=realmadrid" },
    lastMessage: "We watched his scout report, very impressive.",
    time: "Yesterday",
  },
  {
    id: "5",
  ...
  {
    id: "8",
    user: { name: "Manchester United Club", role: "Club", avatar: "https://i.pravatar.cc/100?u=manchester" },
    lastMessage: "Looking forward to receiving the player profile.",
    time: "2 days ago",
  },
];
...
const messagesByConv: Record<string, Message[]> = {
  ...
  "4": [
    { id: "1", text: "Hello, has the player profile been finalized?", time: "Yesterday", isMe: false },
    { id: "2", text: "Yes, we just completed the scouting video cut.", time: "Yesterday", isMe: true },
    { id: "3", text: "We watched his scout report, very impressive.", time: "Yesterday", isMe: false },
  ],
};
...
const participants = [
  ...
  { id: "7", name: "Real Madrid Club", role: "Club", avatar: "https://i.pravatar.cc/100?u=realmadrid" },
  { id: "8", name: "Manchester United Club", role: "Club", avatar: "https://i.pravatar.cc/100?u=manchester" },
];

type FilterTab = "All" | "Parents" | "Agents" | "Clubs" | "Academies";
...
export const AgentChat = () => {
  ...
  const tabs: FilterTab[] = ["All", "Parents", "Agents", "Clubs", "Academies"];
    ...
    <div className="flex flex-col gap-6 h-full min-h-[calc(100vh-120px)]">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-white/40 font-bold uppercase tracking-widest text-[11px] mt-1">
            Communicate with parents, agents, clubs &amp; academies
          </p>
        </div>
        <button
      ...
      <div className="flex flex-1 gap-6 min-h-0">
        ...
        <div className="w-[320px] bg-[#111111] rounded-3xl border border-white/10 flex flex-col overflow-hidden shrink-0">
          ...
          {/* Filter Tabs */}
          <div className="flex gap-1 px-4 pb-3 overflow-x-auto select-none no-scrollbar">
            {tabs.map((tab) => (
              <button
                key={tab}
                onClick={() => setFilterTab(tab)}
                className={`py-1.5 px-2 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${
                  filterTab === tab
